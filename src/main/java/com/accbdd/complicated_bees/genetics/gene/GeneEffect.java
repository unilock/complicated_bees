...
public class GeneEffect extends Gene<IBeeEffect> {
    ...
    public GeneEffect deserialize(CompoundTag tag) {
        ...
        return new GeneEffect(effectKeyString.equals("INVALID") ? null : ComplicatedBees.BEE_EFFECT_REGISTRY.get(ResourceLocation.tryParse(effectKeyString)), tag.getBoolean(DOMINANT));
    }
