...
public class EntitiesRegistration {
    public static final EntityType<BeeStaffProjectile> BEE_STAFF_MOUNT = Registry.register(BuiltInRegistries.ENTITY_TYPE, new ResourceLocation(MODID, "bee_staff_mount"),
